...
export class WholesaleOfferModalComponent {
  ...
  get formProduct(): IProduct | null {
    ...
    return {
      ...
      minWholesaleQuantity: this.offer.minWholesaleQuantity,
      offerPiecesCount: this.offer.offerPiecesCount,
  ...
  async onSave(product: IProduct): Promise<void> {
    ...
    const payload: IWholesaleOffer = {
      ...
      minWholesaleQuantity: product.minWholesaleQuantity || 0,
      offerPiecesCount: product.offerPiecesCount || 0,
